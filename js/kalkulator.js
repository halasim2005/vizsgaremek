function Szamolas(){
    ...
    if((L == "") || (I == "") || (egyFazisRadio.checked == false && haromFazisRadio.checked == false)){
        ...
        hiba.innerHTML = '<div class="alert alert-warning"><strong>Hiba!</strong> Kérem jelöljön be és töltsön ki minden mezőt!</div>';
    }else{
    ...
    egyFazisRadio.checked = false;
    haromFazisRadio = false;
    L.innerHTML = "";
    I = "";
}   
