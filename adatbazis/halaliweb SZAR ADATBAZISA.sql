...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jan 13. 23:12
...
INSERT INTO `felhasznalo` (`felhasznalo_ID`, `fh_nev`, `jelszo`, `vezeteknev`, `keresztnev`, `szamlazasi_iranyitoszam`, `szamlazasi_telepules`, `szamlazasi_utca`, `szamlazasi_hazszam`, `szamlazasi_cegnev`, `szamlazasi_adoszam`, `kezbesitesi_iranyitoszam`, `kezbesitesi_telepules`, `kezbesitesi_utca`, `kezbesitesi_hazszam`, `telefonszam`, `email`, `jogosultsag`) VALUES
(1, 'admin', '$2y$10$ZV5/kz0Yn1IB687p5eqfAuMCureJAlRueIJwPNtionjFT/mh8lUGK', 'a', 'a', 8181, 'Berhida', 'Fő', '99', 'asd', 2147483647, 8181, 'Berhida', 'Fő', '99', '+36 36 242 3423', 'a@gmail.com', 'admin'),
(2, 'b', '$2y$10$/jo.zuoSmbDGDUS6O.4QBuGIcEg5q5uuV/ZrbauzPM18rZvnIube2', 'b', 'b', 0, '', '', '', '', 0, 0, '', '', '', '0', 'b@gmailcom', 'user'),
(3, 'c', 'c', 'c', 'c', 8901, 'Baja', 'jfkdfd', 'sdfsdf', 'dfsdfsd', 12, 5344, 'cgmhgjghj', 'fdfdsf', 'Dfsdfds', 'dfdsfsd', 'a@a.com', 'user');
...
(33, 1, 'dsadas', 'dsada', 323232, 'asdas', 4242, '0000-00-00');
...
--
ALTER TABLE `megrendeles`
  ADD CONSTRAINT `Megrendeles_idegen_kulcs` FOREIGN KEY (`fh_nev`) REFERENCES `felhasznalo` (`felhasznalo_ID`);
